...
<form action="/user/logon" method="post" onsubmit="javascript:return checkForm()">
					...
					<tr>
						<td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
								<tr>
								  ...
								  <td width="27%"> <input name="username" id="username" type="text" size="20" maxlength="20"  value="${model.username }"/></td>
								  <td align="left">&nbsp;</td>
						  </tr>
								<tr>
								...
								<tr>
									...
									<td width="33%" align="left"><a href="/user/findpassword" class="ablue" target="_blank">忘记密码了？</a></td>
								</tr>
							</table>						</td>
					</tr>
					<tr>
					...
					<tr>
						<td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="8%" align="left" valign="middle"><input type="image" id="imageButton1" src="/images/global/regloginbutton2.jpg" alt="" border="0" />&nbsp;</td>
								    <td width="58%" align="left" valign="middle">如果你还未注册，<span style="font-size:14px"><a href='/user/reg_regUI?directUrl=${param.directUrl }' class="ablue2">请免费注册</a>！</span></td>
								</tr>
							</table>						</td>
					</tr>
				</table>
