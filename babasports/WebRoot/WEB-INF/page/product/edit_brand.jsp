...
<form action="/control/brand/manage_edit" method="post" enctype="multipart/form-data" onsubmit="return checkfm(this)">
...
<br>
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <input type="text" name="name" size="50" maxlength="40" value="${brand.name }">
