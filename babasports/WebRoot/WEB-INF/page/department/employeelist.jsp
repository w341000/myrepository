...
<c:forEach items="${pagebean.list}" var="entry">
    <tr>
      <td bgcolor="f5f5f5"> <div align="center"><a href="/control/employee/manage_editEmployeeUI?username=${entry.username}">
	  <img src="/images/edit.gif" width="15" height="16" border="0"></a></div></td>
	  <td bgcolor="f5f5f5"> <div align="center">${entry.username}</div></td>
      <td bgcolor="f5f5f5"> <div align="center"><a href="/control/employee/manage_privilegeGroupSetUI?username=${entry.username}">设置权限</a></div></td>
      ...
      <a href="/control/employee/manage_leave?username=${entry.username}">标志为离职</a>
    ...
    <tr> 
      <td bgcolor="f5f5f5" colspan="11" align="center"><table width="100%" border="0" cellspacing="1" cellpadding="3">
          <tr> 
            <td width="5%"></td>
              <td width="85%">
              <input type="button" class="frm_btn" onClick="javascript:window.location.href='/control/employee/manage_regEmployeeUI'" value="添加员工"> &nbsp;&nbsp;
            </td>
          </tr>
        </table></td>
    </tr>
