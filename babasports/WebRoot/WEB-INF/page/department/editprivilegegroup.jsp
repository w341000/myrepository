...
<form action="/control/privilegegroup/manage_edit" method="post" onsubmit="return checkfm(this)">
<input type="hidden" name="groupid" value="${param.groupid }">
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <input type="text" name="name" value="${group.name }" size="20" maxlength="20"/>
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <c:forEach items="${privileges}" var="privilege" varStatus="statu">
		...
		<c:forEach items="${group.privileges }" var="sp"><c:if test="${sp==privilege}">checked</c:if></c:forEach>
