...
<form action="/control/employee/list" method="get">
<input type="hidden" name="query" value="true">
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <s:select list="#request.departments" listKey="departmentid" listValue="name" name="departmentid" headerKey="" headerValue="请选择部门" /></td>
    </tr>
