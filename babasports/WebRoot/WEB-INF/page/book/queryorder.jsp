...
<form action="/control/order/list" method="get" onsubmit="return checkfm(this)">
  ...
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    <tr bgcolor="6f8ac4"><td colspan="2"  > <font color="#FFFFFF">查询订单：</font></td>
     ...
     <tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <input name="orderid" size="20" maxlength="16"/></td>
    </tr>
   <tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">订单状态：</div></td>
      <td width="78%"><select name="state">
   ...
   <tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <input name="username" size="20" maxlength="16"/></td>
    </tr> 
    <tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">收货人名称：</div></td>
      <td width="78%"><input name="recipients" size="20" maxlength="30"/></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">购买者姓名：</div></td>
      <td width="78%"> <input name="buyer" size="20" maxlength="10"/></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
