...
<form action="/customer/shopping/manage_saveorder" method="post">
                ...
                <TD vAlign=top>
                  ...
                  <TABLE cellSpacing=0 cellPadding=3 width="100%" border=0>
                    <TBODY>
                      <TR>
                        <TD width=184 
                        bgColor=#eeeeee>&nbsp;<STRONG>商品信息：</STRONG><A href="/shopping/cart?directUrl=${directUrl }"><IMG height=17 src="/images/buy/az-s-change.gif" width=45 border=0></A></TD>
        ...
        <TD width="21%">单价：￥<span class="Price">${item.product.sellprice }元</SPAN></TD>
                  ...
                  <TABLE cellSpacing=0 cellPadding=3 width="100%" border=0>
                    ...
                    <TR>
                      ...
                      <TD width="756" bgColor=#eeeeee><a href="/customer/shopping/payment#deliverway"><img height=17 src="/images/buy/az-s-change.gif" width=45 border=0></a></TD>
                    </TR></TBODY></TABLE>
