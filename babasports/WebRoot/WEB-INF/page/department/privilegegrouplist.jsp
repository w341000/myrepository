...
<c:forEach items="${pagebean.list}" var="entry">
    <tr>
      ...
      <td bgcolor="f5f5f5"> <div align="center"><a href="/control/privilegegroup/manage_editUI?groupid=${entry.groupid}">
	  <img src="/images/edit.gif" width="15" height="16" border="0"></a></div></td>
      <td bgcolor="f5f5f5"> <div align="center">${entry.name}</div></td>
      <td bgcolor="f5f5f5"> <div align="center"><a href="/control/privilegegroup/manage_delete?groupid=${entry.groupid}">删除</a></div></td>
	</tr>
</c:forEach>
    <!----------------------LOOP END------------------------------->
    <tr> 
      <td bgcolor="f5f5f5" colspan="4" align="center"><table width="100%" border="0" cellspacing="1" cellpadding="3">
          <tr> 
            <td width="5%"></td>
              <td width="85%">
              <input type="button" class="frm_btn" onClick="javascript:window.location.href='/control/privilegegroup/manage_addUI'" value="添加权限组"> &nbsp;&nbsp;
            </td>
          </tr>
        </table></td>
    </tr>
