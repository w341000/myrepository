...
<BR>
<form action="/customer/shopping/manage_savePaymentway" method="post">
          ...
          <TD bgColor="#ffffff">
            <TABLE cellSpacing=0 cellPadding=4 width="100%" border=0>
              ...
              <TR bgColor="#eeeecc">
				...
				<tr>
				 <TD class="big14" vAlign="middle" align="right" width="10%"><input type="radio" name="deliverway" value="GENERALPOST" onclick="javascript:paymentwaySelect(this.value)"/></TD>
				 <TD vAlign="middle" ><B>平邮</B> (费用:0.0元)&nbsp;&nbsp;不支持货到付款，注:费用最低，需要到附近邮局自提，时间稍长</TD>
				</tr>
				<tr>
				<TD class="big14" vAlign="middle" align="right" width="10%"><input type="radio" name="deliverway" value="EXPRESSDELIVERY" onclick="javascript:paymentwaySelect(this.value)" checked="checked"/></TD>
				 <TD vAlign="middle" ><B>快递送货上门 </B> (费用:0.0元)&nbsp;&nbsp;支持货到付款 &nbsp;&nbsp;注:200个城市可以到达，部分城市不能到达</TD>
				</tr>
				<tr>
				<TD class="big14" vAlign="middle" align="right" width="10%"><input type="radio" name="deliverway" value="EXIGENCEEXPRESSDELIVERY" onclick="javascript:paymentwaySelect(this.value)"/></TD>
				 <TD vAlign="middle" ><B>加急快递送货上门</B> (费用:0.0元)&nbsp;&nbsp;支持货到付款&nbsp;&nbsp;注:200个城市可以到达，部分城市不能到达</TD>
				</tr>
				<tr>
				 <TD class="big14" vAlign="middle" align="right" width="10%"><input type="radio" name="deliverway" value="EMS" onclick="javascript:paymentwaySelect(this.value)"/></TD>
				...
				<tr>
				  ...
				  <TABLE cellSpacing=0 cellPadding=3 width="86%" align="center" id="timerequirement" border=0 style="display:none">
                    <TBODY>
                      ...
                      <TR>
                        <TD align=right><input type="radio" name="requirement" value="工作日、双休日与假日均可送货" /></TD>
                        <TD align=left width="96%">工作日、双休日与假日均可送货</TD>
                      </TR>
                      <TR class=category-row-shaded>
                        <TD align=right><input type="radio" name="requirement" value="只双休日、假日送货" /></TD>
                        <TD align=left>只双休日、假日送货(工作日不用送)</TD>
                      </TR>
                      <TR>
                        <TD align=right><input type="radio" name="requirement" value="只工作日送货(双休日、假日不用送)" /></TD>
                        <TD align=left>只工作日送货(双休日、假日不用送) (注：写字楼/商用地址客户请选择)</TD>
                      </TR>
                      <TR class=category-row-shaded>
                        <TD align=right><input type="radio" name="requirement" value="学校地址/地址白天没人，请尽量安排其他时间送货" /></TD>
        ...
        <TR>
          <TD bgColor=#ffffff>
            <TABLE cellSpacing=0 cellPadding=4 width="100%" border=0>
			 ...
			 <TR>
                <TD class="big14" vAlign="middle" align="right" width="10%"><input type="radio" name="paymentway" value="NET" checked="checked"> </TD>
                <TD vAlign="middle" ><B>网上支付</B>  易宝支付</TD>
			  </TR>
              <TR id="paymentway_COD" >
                <TD class="big14" vAlign="middle" align="right" width="10%"><input type="radio" name="paymentway" value="COD"></TD>
                <TD><B>货到付款</B></TD>
			  </TR>
			  <TR>
                <TD class="big14" vAlign="middle" align="right" width="10%"><input type="radio" name="paymentway" value="BANKREMITTANCE"> </TD> 
                <TD><B>银行电汇</B>  开户名: 北京惠利至易高科技发展有限公司<BR>开户行名称: 
                  交通银行上地支行<BR>银行帐号: 110060974018001084072</TD></TR>
              <TR>
                <TD class="big14" vAlign="middle" align="right" width="10%"><input type="radio" name="paymentway" value="POSTOFFICEREMITTANCE"></TD> 
