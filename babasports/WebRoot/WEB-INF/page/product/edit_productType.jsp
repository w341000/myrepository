...
<form action="/control/product/type/manage_edit" method="post"  onsubmit="return checkfm(this)">
...
<br>
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <input type="text" name="name" size="50" maxlength="50" value="${producttype.name }"/>
        <font color="#FF0000">*</font></td>
    </tr>
	<tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">备注(100字以内)：</div></td>
      <td width="78%"> <input type="text" name="note" size="80" maxlength="100" value="${producttype.note }"/>
        </td>
    </tr>
    <tr bgcolor="f5f5f5"> 
