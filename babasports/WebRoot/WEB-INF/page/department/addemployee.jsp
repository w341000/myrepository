	...
	if(username.trim()!=""){
		...
		if(usernameview){
			send_request(function(value){usernameview.innerHTML=value},
					 '/control/employee/manage_exist?username='+ username, true);
		}
	}
}
function tag(name){
...
<form action="/control/employee/manage_regEmployee" method="post" enctype="multipart/form-data" onsubmit="return checkfm(this)">
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    <tr bgcolor="6f8ac4"><td colspan="2"  > <font color="#FFFFFF">添加员工：</font></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">登录账号：</div></td>
      <td width="78%"> <input type="text" id="username" name="username" size="32" maxlength="32" onblur="javascript:validateUsernameExsit(this.value)" />(账号的长度应大于或等于6,不能用中文)<font color="#FF0000">*</font>
       <div id="usernameview"></div></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">登录密码：</div></td>
      <td width="78%"> <input type="password" id="password" name="password" size="32" maxlength="32"  />(密码的长度应大于或等于6,不能用中文)
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <input type="text" id="realname" name="realname" size="10" maxlength="10"  />
        <font color="#FF0000">*</font></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">性别：</div></td>
      <td width="78%"> <s:radio list="#{'MAN':'男','WOMEN':'女'}" name="gender" value="'MAN'"></s:radio>
      </td>
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <input type="text" id="phone" name="phone" size="20" maxlength="18"  /><font color="#FF0000">*</font></td>
    </tr> 
    <tr bgcolor="f5f5f5"> 
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <c:forEach items="${departments}" var="department" varStatus="statu">      
      	<input type="radio" name="department.departmentid" value="${department.departmentid}">${department.name}	
