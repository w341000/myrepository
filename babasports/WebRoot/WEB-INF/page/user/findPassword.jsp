              ...
              <TR>
                <TD vAlign=top bgColor=#ffffff>
                  ...
                  width="100%" align=center border=0>
                    ...
                    <TR>
                      <TD vAlign=top>
                        <form action="/user/post_getpassword" method="post" name="getp" onsubmit="javascript:return validateForm(this)">
                        <TABLE cellSpacing=4 cellPadding=4 width="100%" border=0>
                          ...
                          <TR align=left>
                            <TD class=font9 colSpan=3>
                              <P class=font9> 如果您忘记密码且不再使用注册时的E-mail，<A class=a-your-account href="/user/reg_regUI">建议创建一个新帐户</A>。</P></TD></TR></TBODY></TABLE>
</form>
