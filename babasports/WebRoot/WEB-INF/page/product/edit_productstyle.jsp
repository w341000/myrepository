...
<form action="/control/product/style/manage_edit" method="post" enctype="multipart/form-data" onsubmit="return checkfm(this)">
<input type="hidden" name="id" value="${param.id }">
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <input type="text" name="name" size="50" maxlength="40" value="${style.name }">
        <font color="#FF0000">*</font></td>
    </tr>
	<tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">产品图片：</div></td>
      <td width="78%"> <input type="file" name="imagefile" size="50"><br>
      <img src="${style.imageFullPath }" width="100">
      </td>
    </tr>
    <tr bgcolor="f5f5f5"> 
